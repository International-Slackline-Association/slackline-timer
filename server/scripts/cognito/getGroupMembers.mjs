...
//   node scripts/cognito/getGroupMembers.mjs <group> --profile <profile>

import { attr, parseArgs, requireConfig, runAws, runMain } from './cognitoCommon.mjs';

const HELP = `list the members of a Cognito group (default: $COGNITO_TIMER_GROUP)
...
runMain(async () => {
  ...
  requireConfig({ ...opts, group }, 'poolId', 'region', 'group');
